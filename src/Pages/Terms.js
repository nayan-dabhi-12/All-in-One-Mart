        ...
        <div className="terms py-4">
          <div className="container py-md-5 py-4">
            ...
            <ol start={1} className="pl-sm-4 pl-3">
              <li className="font-weight-light pl-sm-4 mb-2">
            ...
            <p className="font-weight-light pl-sm-4 mb-2">
            ...
            <h6 className="my-md-4 my-3">Eligibility :</h6>
            <p className="font-weight-light pl-sm-4 mb-2">
            ...
            <h6 className="my-md-4 my-3">Cancellation by Site / Customer</h6>
            <p className="font-weight-light pl-sm-4 mb-2">
              {" "}
            ...
            <h6 className="my-md-4 my-3">You Agree and Confirm</h6>
            <p className="font-weight-light pl-sm-4 mb-2">
            ...
            <h6 className="my-md-4 my-3">Copyright &amp; Trademark</h6>
            <p className="font-weight-light pl-sm-4 mb-2">
              {" "}
